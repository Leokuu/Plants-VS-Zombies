...
#include "../../PLantsVsZombies/card.h"
...
QT_MOC_LITERAL(1, 5, 16), // "CanStartFighting"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 19), // "CannotStartFighting"
QT_MOC_LITERAL(4, 43, 10) // "PlcaePlant"

    },
    "Card\0CanStartFighting\0\0CannotStartFighting\0"
    "PlcaePlant"
};
...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CanStartFighting(); break;
        case 1: _t->CannotStartFighting(); break;
        case 2: _t->PlcaePlant((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Card::CanStartFighting)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Card::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Card::CannotStartFighting)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Card::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Card::PlcaePlant)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Card::CanStartFighting()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Card::CannotStartFighting()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Card::PlcaePlant(int _t1)
{
