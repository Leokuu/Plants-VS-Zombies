...
const QMetaObject Zombies::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Zombies.data,
      qt_meta_data_Zombies,  qt_static_metacall, nullptr, nullptr}
};
...
void *Zombies::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Zombies.stringdata0))
        return static_cast<void*>(const_cast< Zombies*>(this));
...
const QMetaObject NormalZombie::staticMetaObject = {
    { &Zombies::staticMetaObject, qt_meta_stringdata_NormalZombie.data,
      qt_meta_data_NormalZombie,  qt_static_metacall, nullptr, nullptr}
};
...
void *NormalZombie::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NormalZombie.stringdata0))
        return static_cast<void*>(const_cast< NormalZombie*>(this));
