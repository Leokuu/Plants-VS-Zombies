...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Card::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Card::CanStartFighting)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Card::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Card::CannotStartFighting)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Card::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Card::PlcaePlant)) {
                *result = 2;
                return;
            }
        }
